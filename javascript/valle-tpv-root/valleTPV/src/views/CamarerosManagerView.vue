<template>
  ...
  >
    <template #actions>
      ...
      <UiActionButton v-if="camarerosAuth.length > 0" icon="mdi-cash-register" @click="irAlTPV">Ir al TPV</UiActionButton>
    </template>
      ...
      <v-col cols="12" md="6">
        <v-card elevation="2" class="mb-4 h-100">
          ...
          <div class="scroll-list" ref="listNoAuth">
            <v-list>
              <v-list-item
                v-for="camarero in camarerosNoAuth"
                :key="camarero.id"
      ...
      <v-col cols="12" md="6">
        <v-card elevation="2" class="mb-4 h-100">
          ...
          <div class="scroll-list" ref="listAuth">
            <v-list>
              <v-list-item
                v-for="camarero in camarerosAuth"
                :key="camarero.id"
...
.scroll-list {
  ...
  overscroll-behavior: contain; /* Prevenir scroll en cadena */
...
.v-list-item {
  cursor: pointer;
  touch-action: manipulation; /* Optimizar para táctil */
