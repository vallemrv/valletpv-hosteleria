...
@Composable
fun CobrarMesaDialog(modelCuenta: CuentaModel, onDismiss: (Double?, Double?) -> Unit) {
    ...
    Dialog(onDismissRequest = { onDismiss(null, null) }) {
        Surface(color = ColorTheme.Background, modifier = Modifier.size(1800.dp, 400.dp)) {
