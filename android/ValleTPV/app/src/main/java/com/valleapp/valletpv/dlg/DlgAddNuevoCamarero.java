...
public class DlgAddNuevoCamarero extends Dialog {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final TextView nombre = (TextView) this.findViewById(R.id.txt_add_cam_nombre);
        final TextView apellidos = (TextView) this.findViewById(R.id.txt_add_cam_apellido);
        Button ok = (Button) this.findViewById(R.id.btn_add_cam_aceptar);
        Button s = (Button) this.findViewById(R.id.btn_add_cam_salir);
        ...
        ok.setOnClickListener(view -> {
            ...
            try {
                ...
                if (n.isEmpty() && a.isEmpty()){
                    ...
                    DbCamareros dbCam = (DbCamareros) servicio.getDb("camareros");
                    dbCam.addCamNuevo(n, a);
