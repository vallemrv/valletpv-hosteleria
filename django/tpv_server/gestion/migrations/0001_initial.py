# Generated by Django 3.0.6 on 2020-05-22 06:54
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('descripcion_r', models.CharField(blank=True, db_column='Descripcion_r', max_length=50, null=True, verbose_name='Descripción recepción')),
                ('descripcion_t', models.CharField(blank=True, db_column='Descripcion_t', max_length=50, null=True, verbose_name='Descripción ticket')),
                ('tipo', models.CharField(choices=[('SP', 'SIMPLE'), ('ML', 'MULTIPLE'), ('GR', 'GRUPO')], default='SP', max_length=2)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hora', models.CharField(db_column='Hora', max_length=5)),
                ('camarero_id', models.IntegerField(db_column='IDCam')),
                ('mensaje', models.CharField(db_column='Mensaje', default='', max_length=150, null=True)),
                ('infmesa', models.ForeignKey(db_column='UID', on_delete=django.db.models.deletion.CASCADE, to='gestion.Infmesa')),
            ],
            options={
                'db_table': 'pedidos',
