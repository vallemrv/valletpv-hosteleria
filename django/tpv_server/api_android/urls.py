...
urlpatterns = [
    ...
    path('mesas/', include("api_android.set_urls.mesas"), name="api_android_mesas"),
    ...
    path('secciones/', include("api_android.set_urls.secciones"), name="api_android_secciones"),
    path('articulos/', include("api_android.set_urls.articulos"), name="api_android_articulos"),
