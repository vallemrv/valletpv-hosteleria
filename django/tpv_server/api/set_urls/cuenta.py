...
from api.views.api_cuenta import (
    cuenta_add, cuenta_ls_linea, cuenta_ls_ticket, get_cuenta,
    juntarmesas, cambiarmesas, mvlineamultiple, cuenta_cobrar, 
     cuenta_rm_linea,
    )
...
urlpatterns  = [
    ...
    path("mvlineamultiple", mvlineamultiple, name="cuenta_mvlineamultiple"),
