from ...tools.utils import get_total_by_horas, get_total
from tokenapi.http import JsonResponse
from tokenapi.decorators import token_required
from valle_tpv.models import (Arqueocaja, Camareros, Historialnulos,
                            Infmesa, Mesas, Ticket, Mesasabiertas)
